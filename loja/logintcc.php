...
<head>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="na <a class="navbar-brand" href="#"><img src= "./img/jesonelputobranco.png"alt="Image" height="16" width="16" style=" height:20px"><font color="#e92187">Tia Cleide Store</font></a>
