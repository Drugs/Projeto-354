...
<div class="d-flex flex-column p-3 text-white bg-dark" style="position: absolute;flex-shrink: 0;top: -5px;width: 272px;height: 100%;">
	...
	<div class="container" style="/* box-sizing: border-box; */padding: calc(100% -274px);float: right;width: calc(100% - 278px);">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top mt-4">
	...
	<ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"></svg><i class="bi bi-twitter"></i></a></li>
      <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"></svg><i class="bi bi-instagram"></i></a></li>
      <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"></svg><i class="bi bi-facebook"></i></a></li>
    </ul>
  </footer>
</div>
